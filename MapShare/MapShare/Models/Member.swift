...
class Member {
    ...
    init(firstName: String, lastName: String, screenName: String, mapMarkerColor: String, memberDeviceID: String, isOrganizer: Bool, isActive: Bool, expectedTravelTime: Double? = nil) {
...
extension Member {
    convenience init?(fromMemberDictionary memberDictionary: [String : Any]) {
        guard let firstName           = memberDictionary[MemberKey.firstName] as? String,
              ...
              let isActive            = memberDictionary[MemberKey.isActive] as? Bool else {
        ...
        self.init(firstName: firstName, lastName: lastName, screenName: screenName, mapMarkerColor: mapMarkerColor, memberDeviceID: memberDeviceID, isOrganizer: isOrganizer, isActive: isActive, expectedTravelTime: expectedTravelTime)
    }
}
