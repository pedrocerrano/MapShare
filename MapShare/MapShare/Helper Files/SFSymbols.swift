...
enum SFSymbols {
    ...
    static let singleMember    = "location.circle.fill"
    static let multipleMembers = "location.fill.viewfinder"
    ...
    static let routeAnnotationButton = "arrowshape.turn.up.right.circle.fill"
}
