...
struct Alerts {
    ...
    static func needSessionName() -> UIAlertController {
        let needSessionNameAlertController = UIAlertController(title: "Need Session Name", message: "Please name this MapShare Session.", preferredStyle: .alert)
    ...
    static func needFirstName() -> UIAlertController {
        let needFirstNameAlertController = UIAlertController(title: "Need First Name", message: "Please share your first name for others to identify you.", preferredStyle: .alert)
    ...
    static func needLastName() -> UIAlertController {
        let needLastNameAlertController = UIAlertController(title: "Need Last Name", message: "Please share your last name for others to identify you.", preferredStyle: .alert)
        let dismissAction = UIAlertAction(title: "Okay", style: .cancel)
    ...
    static func needColorChoice() -> UIAlertController {
        let needColorChoiceAlertController = UIAlertController(title: "Select Color", message: "Please select your marker color to join.", preferredStyle: .alert)
        let dismissAction = UIAlertAction(title: "Okay", style: .cancel)
    ...
    static func onlySixDigits() -> UIAlertController {
        let onlySixDigitsAlertController = UIAlertController(title: "Invalid Session Code", message: "Please retype a valid six-digit session code.", preferredStyle: .alert)
        let dismissAction = UIAlertAction(title: "Okay", style: .cancel)
